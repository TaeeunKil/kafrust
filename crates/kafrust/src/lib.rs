...
pub use admin::{
    ...
    DescribeTransactionsResult, DescribeUserScramCredentialsResult, ElectLeadersOptions,
    ...
    ListTransactionsOptions, ListTransactionsResult, ListedTransaction, NewPartitions, NewTopic,
