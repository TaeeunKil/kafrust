...
pub use admin::{
    ...
    DescribeProducersTopic, DescribeProducersTopicResult, DescribeTopicPartitionsCursor,
    ...
    LogDirectoryPartitionResult, LogDirectoryResult, LogDirectoryTopicResult, NewPartitions,
    NewTopic, OngoingPartitionReassignment, OngoingPartitionReassignmentTopic,
