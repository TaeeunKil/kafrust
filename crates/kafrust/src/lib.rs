...
pub use admin::{
    ...
    AlterPartitionReassignmentsResult, AlterScramCredentialResult, AlterUserScramCredentialsResult,
    BrokerDescription, ClientQuotaAlteration, ClientQuotaEntity, ClientQuotaEntityComponent,
    ClientQuotaFilter, ClientQuotaFilterComponent, ClientQuotaMatchType, ClientQuotaOperation,
    ClientQuotaValue, ClusterDescription, ConfigAlterOperation, ConfigAlterOperationKind,
    ...
    CreateAclsEntryResult, CreateAclsResult, CreatePartitionsOptions, CreatePartitionsResult,
    CreatePartitionsTopicResult, CreateTopicResult, CreateTopicsOptions, CreateTopicsResult,
    DeleteAclsFilterResult, DeleteAclsResult, DeleteConsumerGroupOffsetsPartitionResult,
    DeleteConsumerGroupOffsetsResult, DeleteConsumerGroupOffsetsTopicResult,
    DeleteConsumerGroupResult, DeleteRecordsOptions, DeleteRecordsPartition,
    DeleteRecordsPartitionResult, DeleteRecordsResult, DeleteRecordsTopic,
    ...
    DescribeConfigsResult, DescribeLogDirsBrokerResult, DescribeProducersActiveProducer,
    DescribeProducersPartitionResult, DescribeProducersResult, DescribeProducersTopic,
    DescribeProducersTopicResult, DescribeTransactionsResult, DescribeUserScramCredentialsResult,
