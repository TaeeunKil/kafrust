...
## Q-PUBLISHED-PERFORMANCE-CAMPAIGN-DIAGNOSTIC-2026-09-03

- date_utc: 2026-09-03
- source_commit: e89e4d602a3ce12b8e32b4c2b339a7f50956ce68
- client_version: 0.3.6 published artifact
- protocol_version: 0.3.6 published dependency
- work_status: In progress
- evidence_level: Published artifact
...
- memory: RSS baseline-to-terminal growth 0 bytes; measured slope 491-15,073 bytes/second by profile
...
## Q-COMPANY-BROKER-ROUNDTRIP-2026-09-03
...
- kafka_version: 4.3.1
- kafka_image: apache/kafka@sha256:77e3df9054047a88b520d0cc46e16696d3b22022e1d580aeccd2632df6532837
- mode: company WSL2 complete broker roundtrip smoke
- topology: isolated single-node KRaft with one named container and port 19092
- security: PLAINTEXT
- group_protocol: not-applicable; Share phases intentionally skipped
- workload: broker_roundtrip integration target, data-plane version negotiation, and one-record Produce/Fetch roundtrip
- workflow: scripts/check_qualification_ledger.py
- fault: valid broker responses after strict response-boundary and client regression changes
- duration: one broker test run under two minutes
- record_count: one produced and fetched record
- member_count: not-applicable
- repetition_count: one bounded run; 13 test cases
- expected_errors: no errors on configured non-Share paths
- observed_errors: 13 passed; 0 failed; Share-specific phases skipped by configuration
- retry_count: not measured
- duplicate_count: zero observed in fetched probe record
- loss_count: zero observed in fetched probe record
- latency: not measured
...
## Q-BUFFERED-QUEUE-EXPIRY-2026-09-03

- date_utc: 2026-09-03
- source_commit: fb2778b370e466af01f08d60e6d0ec26053cc1e5
- client_version: 0.3.6 source checkout
- protocol_version: 0.3.6 source checkout
- work_status: In progress
- evidence_level: Local deterministic
- kafka_version: not-applicable; scripted broker with no response steps
- kafka_image: not-applicable
- mode: buffered producer queue-expiry/no-transmission regression
- topology: in-memory scripted broker; no Produce response configured
- security: not-applicable
- group_protocol: not-applicable
- workload: one buffered record with 20 ms delivery budget and 10 second linger
- workflow: scripts/check_qualification_ledger.py
- fault: queue deadline expires before linger-triggered Produce flush
- duration: deterministic integration test under one second
- record_count: one accepted and expired buffered record
- member_count: not-applicable
- repetition_count: one bounded scripted run
- expected_errors: DeliveryDeadlineExceeded phase Queue, possibly_transmitted false, zero Produce frames
- observed_errors: typed queue deadline returned; buffered gauge drained; broker observed zero requests
- retry_count: 0
- duplicate_count: 0
- loss_count: 0
- latency: not measured
...
## Q-ADMIN-CONTROLLER-CANCELLATION-MATRIX-2026-09-07

- date_utc: 2026-09-07
- source_commit: 146f98d646cd527a413b081bc1da8d89f8565a69
- client_version: 0.3.6 source workspace
- protocol_version: CreateTopics v2; DeleteTopics v3; CreatePartitions v0; ElectLeaders v2; AlterPartitionReassignments v0; UpdateFeatures v1; AddRaftVoter v1; RemoveRaftVoter v0; UnregisterBroker v0
- work_status: In progress
- evidence_level: Local deterministic
- kafka_version: scripted transport fixture
- kafka_image: not-applicable
- mode: common controller mutation cancellation after transmission
- topology: scripted bootstrap and controller TCP sockets
- security: PLAINTEXT fixture
- group_protocol: not-applicable
- workload: one complete request for each of nine common controller mutations
- workflow: scripts/check_qualification_ledger.py
- fault: response withheld after each complete mutation frame; caller future dropped
- duration: focused matrix under one second
- record_count: nine mutation requests
- member_count: not-applicable
...
- observed_errors: every controller connection reached EOF after cancellation; no response/replay
- retry_count: 0
- duplicate_count: 0
- loss_count: nine intentionally withheld responses
- latency: not measured
- memory: not measured
- final_resource_gauges: scripted controller tasks joined; no external resources
- result: passed
- artifact: `docs/evidence/v1-admin-controller-cancellation-matrix-2026-09-07.md`; `crates/kafrust/src/admin.rs`
...
## Q-ADMIN-DELETE-TOPICS-CANCELLATION-2026-09-07

- date_utc: 2026-09-07
- source_commit: 3702d796609eaddde4c44ed586fb910b6f984850
- client_version: 0.3.6 source workspace
- protocol_version: DeleteTopics v3
- work_status: In progress
- evidence_level: Local deterministic
- kafka_version: scripted transport fixture
- kafka_image: not-applicable
...
- security: PLAINTEXT fixture
- group_protocol: not-applicable
- workload: one DeleteTopics mutation request
- workflow: scripts/check_qualification_ledger.py
- fault: complete DeleteTopics frame observed, response withheld, caller future dropped
- duration: focused test under one second
- record_count: one mutation request
- member_count: not-applicable
- repetition_count: one cancellation regression
- expected_errors: possibly-transmitted mutation connection must not remain reusable
- observed_errors: controller connection reached EOF after cancellation; no response/replay
- retry_count: 0
- duplicate_count: 0
- loss_count: one withheld response
...
- final_resource_gauges: scripted controller task joined; no external resources
- result: passed
- artifact: `docs/evidence/v1-admin-delete-topics-cancellation-2026-09-07.md`; `crates/kafrust/src/admin.rs`
- non_claims: no broker application-state conclusion, not complete controller cancellation matrix, not published/live/long-campaign/release evidence
...
## Q-DESIGN-V121-RATE-LIMITED-2026-09-04

- date_utc: 2026-09-04
- source_commit: 5de8fa7232a418f11c87210f0c1a1db7b7b25815
...
- mode: rate-limited RF3 lifetime diagnostic preparation
...
- workflow: scripts/check_campaign_capacity.sh
- fault: none in the prepared workflow; no campaign dispatched
- duration: not-run; configured maximum 7,200 seconds
- record_count: not-run
- member_count: not-applicable
- repetition_count: not-run
- expected_errors: disk watermark abort below 40 GiB, typed zero-rate rejection, and zero final in-flight/buffered gauges on a successful diagnostic
...
- date_utc: 2026-09-04
- source_commit: 5aa6b45164d3b5b90d4da88dee2b749334a10418
- client_version: 0.3.6 published artifact
- protocol_version: KIP-848 consumer group lifecycle over SASL_SSL/SCRAM-SHA-256
- work_status: In progress
- evidence_level: Published artifact
- kafka_version: 4.3.1
- kafka_image: apache/kafka@sha256:47dccc76b32761bc57462b8753144cdbb73a16b123b1d13d3eedb92bb7952b11
- mode: bounded secure group churn timeout calibration
- topology: three-broker KRaft
- security: SASL_SSL/SCRAM-SHA-256
- group_protocol: KIP-848 consumer protocol
- workload: six partitions; two members; 40 requested abrupt drop/rejoin cycles with committed-offset restoration
- workflow: https://github.com/TaeeunKil/kafrust/actions/runs/33830996464
- fault: helper 20-minute cycle budget expired before the requested 40 cycles completed
- duration: 20 minutes for the helper; 21 minutes 18 seconds workflow wall time
- record_count: 138 ownership observations through cycle 23; six per completed cycle
- member_count: 2
- repetition_count: one timeout calibration run
- expected_errors: helper completes all 40 cycles without loss or duplicates
- observed_errors: cycles 1-23 passed; helper timed out before cycle 24; no loss or duplicate assertion was reported
- retry_count: 0
- duplicate_count: 0
- loss_count: 0
- latency: not measured
- memory: not measured
- final_resource_gauges: helper assertion not reached; workflow cleanup completed
- result: failed
- artifact: docs/evidence/v1-published-secure-group-churn-40-cycle-2026-09-04.md; .github/published-secure-group-rebalance-smoke/src/main.rs; https://github.com/TaeeunKil/kafrust/actions/runs/33830996464
- non_claims: not a passing 40-cycle profile, not a source regression finding, not long-campaign evidence, not service canary, not release authorization

## Q-PUBLISHED-SECURE-GROUP-CHURN-40-CLASSIC-2026-09-04
...
- kafka_version: 3.7.2
- kafka_image: apache/kafka@sha256:6d8457e841c10f58f952cb3942a38b6b3c21015b643e3dd010aea37cc0b89055
- mode: published secure accepted-floor 40-cycle drop/rejoin diagnostic
- topology: three-broker KRaft
- security: SASL_SSL/SCRAM-SHA-256
- group_protocol: classic consumer protocol
- workload: six partitions; two members; 40 abrupt drop/rejoin cycles with committed-offset restoration
- workflow: https://github.com/TaeeunKil/kafrust/actions/runs/33830994497
- fault: second member connection dropped and rejoined on every cycle
- duration: 9 minutes 1 second workflow wall time
- record_count: 240 ownership observations; six per cycle
- member_count: 2
- repetition_count: 40 churn cycles
...
## Q-PUBLISHED-SECURE-GROUP-CHURN-40-KIP848-2026-09-04

- date_utc: 2026-09-04
- source_commit: 5742d5b816f061daaa92358379cce94d1101ec16
- client_version: 0.3.6 published artifact
- protocol_version: KIP-848 consumer group lifecycle and member-aware OffsetCommit/OffsetFetch path
- work_status: In progress
- evidence_level: Published artifact
- kafka_version: 4.3.1
- kafka_image: apache/kafka@sha256:47dccc76b32761bc57462b8753144cdbb73a16b123b1d13d3eedb92bb7952b11
- mode: published secure 40-cycle drop/rejoin diagnostic
- topology: three-broker KRaft
- security: SASL_SSL/SCRAM-SHA-256
- group_protocol: KIP-848 consumer protocol
- workload: six partitions; two members; 40 abrupt drop/rejoin cycles with committed-offset restoration
- workflow: https://github.com/TaeeunKil/kafrust/actions/runs/33832439518
- fault: second member connection dropped and rejoined on every cycle
- duration: 34 minutes 46 seconds workflow wall time
- record_count: 240 ownership observations; six per cycle
- member_count: 2
- repetition_count: 40 churn cycles
- expected_errors: every cycle reacquires all six partitions, restores committed offsets, and ends without loss or duplicates
...
## Q-PUBLISHED-SECURE-GROUP-CHURN-40-LEAVE-CLASSIC-2026-09-04

- date_utc: 2026-09-04
- source_commit: 2c0d6d8165719ac9e7fe85bb7ac9f4154377225b
- client_version: 0.3.6 published artifact
- protocol_version: classic consumer group lifecycle and OffsetCommit/OffsetFetch path
- work_status: In progress
- evidence_level: Published artifact
- kafka_version: 3.7.2
- kafka_image: apache/kafka@sha256:6d8457e841c10f58f952cb3942a38b6b3c21015b643e3dd010aea37cc0b89055
- mode: published secure 40-cycle normal-leave diagnostic
- topology: three-broker KRaft
- security: SASL_SSL/SCRAM-SHA-256
- group_protocol: classic consumer protocol
- workload: six partitions; two members; 40 normal LeaveGroup/rejoin cycles with committed-offset restoration
- workflow: https://github.com/TaeeunKil/kafrust/actions/runs/33834878818
- fault: second member issued LeaveGroup and rejoined on every cycle
- duration: 9 minutes 14 seconds workflow wall time
- record_count: 240 ownership observations; six per cycle
- member_count: 2
- repetition_count: 40 churn cycles
- expected_errors: every cycle reacquires all six partitions, restores committed offsets, and ends without loss or duplicates
...
## Q-PUBLISHED-SECURE-GROUP-CHURN-40-LEAVE-KIP848-2026-09-04
...
- group_protocol: KIP-848 consumer protocol
- workload: six partitions; two members; 40 normal LeaveGroup/rejoin cycles with committed-offset restoration
- workflow: https://github.com/TaeeunKil/kafrust/actions/runs/33834880832
- fault: second member issued LeaveGroup and rejoined on every cycle
- duration: 5 minutes 29 seconds workflow wall time
- record_count: 240 ownership observations; six per cycle
- member_count: 2
- repetition_count: 40 churn cycles
- expected_errors: every cycle reacquires all six partitions, restores committed offsets, and ends without loss or duplicates
...
- client_version: 0.3.6 published artifact
- protocol_version: Metadata v12 and Produce v13 topic-UUID path
- work_status: In progress
- evidence_level: Published artifact
- kafka_version: 4.3.1
- kafka_image: apache/kafka:4.3.1
- mode: published three-broker topic UUID and leader movement diagnostic
- topology: three-broker KRaft
- security: PLAINTEXT
- group_protocol: KIP-848 consumer protocol
- workload: published pre/post produce and consume around a selected partition leader restart
- workflow: https://github.com/TaeeunKil/kafrust/actions/runs/33827383799
- fault: stopped broker 1; partition 0 moved to replacement broker 2
- duration: 1 minute 20 seconds workflow wall time
- record_count: two one-record phases; pre offset 0 and post offset 1
- member_count: one consumer group member per phase
- repetition_count: one bounded published failover run
- expected_errors: leader movement and recovery with unchanged topic UUID and no data loss
- observed_errors: pre/post success; topic UUID identical; no failure
- retry_count: not measured
- duplicate_count: 0
...
- result: passed
- artifact: docs/evidence/v1-published-topic-id-leader-movement-2026-09-04.md; .github/published-multi-broker-smoke/src/main.rs; .github/workflows/published-multi-broker-smoke.yml
- non_claims: not V1-03 completion, not official Apache response oracle for every shape, not full V1-20 matrix, not long campaign, not service canary, not release authorization
