...
- follow-up source commit: `0a7b0426488cfe7040bdf71794bcccf97ff6a45d` (v9 fallback)
- second follow-up source commit: `a0029bebe4b2f6ed7442f22371f3f9467330409b` (v10)
- tests: `admin::tests::classifies_consumer_group_offset_commit_disconnect_as_unknown`, `admin::tests::classifies_member_aware_consumer_group_offset_commit_disconnect_as_unknown`, `admin::tests::classifies_member_aware_v10_offset_commit_disconnect_as_unknown`, `admin::tests::classifies_consumer_group_offset_delete_disconnect_as_unknown`, `admin::tests::classifies_delete_group_disconnect_as_unknown`
- topology: in-memory scripted broker
- APIs: OffsetCommit v2; OffsetDelete v0; DeleteGroups v1

## Checks

Five independent fixtures discovered the group coordinator, read one complete
...
boundary; the v10 fixture additionally verifies topic UUID encoding and no
fixture permits a blind replay.
...
including the member-aware v9 fallback and v10 topic-UUID path; published floor/authorization
