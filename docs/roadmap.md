...
- KIP-848 `ConsumerGroupHeartbeat v0` protocol types, Metadata v12 UUID
  ...
  with assignment application, member-epoch heartbeats/rejoin, OffsetCommit
  v9, explicit leave, and injected low-level roundtrip coverage.
...
- Kafka 4.3.1 KIP-848 live qualification passed in
  ...
  OffsetCommit v9, transient coordinator retry, and explicit leave.
