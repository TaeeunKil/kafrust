...
- The high-level producer can send multiple records with `Producer::send_batch`, grouping records by topic, partition, and leader. Byte-size batch limits and linger-based buffering are still planned.
