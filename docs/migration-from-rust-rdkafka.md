...
| ACL describe/create/delete with an authorizer-enabled broker | Verified on Kafka 3.7.2; DescribeAcls v1 also retries a dropped read request within the bounded AdminClient budget, with focused mock-broker coverage. Published `0.2.28` restricted-user StandardAuthorizer paths passed on Kafka 3.7.2 and 4.3.1, including allowed cluster/topic/group operations and denied topic-config/create/delete outcomes in [`31741997691`](https://github.com/TaeeunKil/kafrust/actions/runs/31741997691) and [`31742115305`](https://github.com/TaeeunKil/kafrust/actions/runs/31742115305); qualify target permissions, policy, every Admin API, and broker-stop behavior |
