...
| Consumer-group offset listing and administrative alteration | Candidate; classic OffsetFetch v2 and OffsetCommit v2 are live-verified on Kafka 3.7.2, 3.8.1, 3.9.1, and 4.3.1 in [`Live Kafka Smoke` run `31595485915`](https://github.com/TaeeunKil/kafrust/actions/runs/31595485915); qualify target authorization and KIP-848 member-aware workflows separately |
