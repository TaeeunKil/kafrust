...
| Idempotent producer | Candidate; broker-stop recovery is live-verified on the documented three-broker profile, and the published `0.2.28` artifact produced through a replacement leader in [`Published Multi-Broker Smoke` run `31735177161`](https://github.com/TaeeunKil/kafrust/actions/runs/31735177161) and authenticated `SASL_SSL/SCRAM-SHA-256` profiles in [`31738997447`](https://github.com/TaeeunKil/kafrust/actions/runs/31738997447) and [`31739154764`](https://github.com/TaeeunKil/kafrust/actions/runs/31739154764), but qualify target-specific ambiguous, fencing, and throughput failures |
| Direct assigned-partition consumer | Candidate |
| Classic range-assigned consumer group | Candidate with rebalance testing; published `0.2.28` two-member ownership and record delivery passed on Kafka 3.7.2 in [`Published Group Rebalance Smoke` run `31736939236`](https://github.com/TaeeunKil/kafrust/actions/runs/31736939236) |
...
| TLS, SASL/PLAIN, or SASL/SCRAM-SHA-256 | Candidate on documented profiles; published `0.2.28` external projects passed three-broker `SASL_SSL/SCRAM-SHA-256` leader failover for Kafka 3.7.2 classic and Kafka 4.3.1 KIP-848 in [`31738997447`](https://github.com/TaeeunKil/kafrust/actions/runs/31738997447) and [`31739154764`](https://github.com/TaeeunKil/kafrust/actions/runs/31739154764); qualify target authorization, coordinator-plus-leader faults, and broader security/workload matrices |
...
| Delegation token lifecycle | Implemented with negotiated Create/Describe v1-v3 and Renew/Expire v1-v2, flexible encoding, controller routing, and HMAC redaction; focused protocol and mock-broker coverage passes; live qualification and target authorization policy remain required |
